 ...
 *         6 dueDay (offset from 2022-01-01, -1 unknown), 7 docNo, 8 blocked] */
...
export const fmtDue = (d: number) =>
  d >= 0 ? new Date(EPOCH_MS + d * 86400000).toLocaleDateString("en-IN", { day: "2-digit", month: "short", year: "2-digit" }) : "—";
